...
short CountOddNumbersInArray(short Array[100],short arrLength) {

	short Count = 0;

	for (short i = 0; i < arrLength; i++) {
		if (CheckOddOrEven(Array[i] )==Odd){
			Count++;
		}
	}
	return Count;
...
int main()
{
	...
	cout << "\nOdd numbers count is : " << CountOddNumbersInArray(Array, arrLength)<<endl;
}
