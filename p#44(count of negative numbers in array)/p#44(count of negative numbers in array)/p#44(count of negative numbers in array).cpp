...
short CountNegativeNumbersInArray(short Array[100],short arrLength) {

	short Count = 0;

	for (short i = 0; i < arrLength;i++) {

		if (CheckPositiveOrNegative(Array[i]) == Negative) {
...
int main()
{
	...
	cout << "\nNegative number count is: " << CountNegativeNumbersInArray(Array, arrLength)<<endl;
}
